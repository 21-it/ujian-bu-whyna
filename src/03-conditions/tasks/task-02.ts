...
const empolyeeName: string = "Dimas Pratama"
const performanceScore: number = 78
const minimumPerformanceScore: number = 80

console.log("\n==== Employee Data ====\n")
console.log("Employee Name: " + empolyeeName)
console.log("Performance Score: " + performanceScore)
console.log("Minimum Performance Score: " + minimumPerformanceScore)

if (performanceScore >= minimumPerformanceScore) {
    console.log("Result: Bonus Approved")
}   else {
    console.log("Result: Bonus not approved")
}
